...
<table width="1362" cellpadding="1" cellspacing="1">
  <tr>
    ...
    <td width="534" bgcolor="#55f631"><input type="text" name="textfield2" id="textfield2" />
    <input type="password" name="textfield3" id="textfield3" />
    <input type="submit" name="button2" id="button2" value="Login" />
    <input type="submit" name="button3" id="button3" value="Register" /></td>
  </tr>
</table>
...
<table width="1352" height="681" cellpadding="0" cellspacing="1">
  <tr>
    <th width="1234" height="26" align="left" bgcolor="#a1ecdf" scope="col"><blockquote>
      <h1>Tentang Kami</h1>
    </blockquote></th>
  </tr>
  <tr>
